...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "gullNetwork") type = gullNetwork;
    if(strType == "gullNetworkVariable") type = gullNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == gullNetwork) s = "gullNetwork";
    if(type == gullNetworkVariable) s = "gullNetworkVariable";
