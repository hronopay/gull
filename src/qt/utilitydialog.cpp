    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("gull Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About gull Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  gull-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the gull in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 gull, 0.1 gull, 1 gull and 10 gull -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://gullpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://gullpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("gull Core is shutting down...") + "<br /><br />" +
