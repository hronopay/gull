    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("gull Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a gull address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gull: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About gull Core"), this);
    aboutAction->setStatusTip(tr("Show information about gull Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for gull Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your gull addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified gull addresses"));
    ...
    openAction->setStatusTip(tr("Open a gull: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the gull Core help message to get a list with possible gull Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("gull Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to gull network", "", count));
    } else {
...
{
    QString strTitle = tr("gull Core"); // default title
