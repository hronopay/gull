...
Only requiring some minor changes is gull.cpp.
...
Changes to gull.cpp
----------------------
gull.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
