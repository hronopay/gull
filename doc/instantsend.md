...
This mechanism has been integrated into Bitcore-Node-gull which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gullpay/insight-api-gull#web-socket-api](https://github.com/gullpay/insight-api-gull#web-socket-api)
* API: [https://github.com/gullpay/insight-api-gull#instantsend-transactions](https://github.com/gullpay/insight-api-gull#instantsend-transactions)
...
By default, the gull Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the gull Core daemon:
