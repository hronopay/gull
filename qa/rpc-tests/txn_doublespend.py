...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 gull:
        ...
        # First: use raw transaction API to send 12400 gull to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 gull coin each
        ...
        # Node0's balance should be starting balance, plus 500gull for another
        ...
        # Node0's total balance should be starting balance, plus 1000gull for
